...
[![R-CMD-check](https://github.com/ropensci-review-tools/roreviewapi/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/ropensci-review-tools/roreviewapi/actions/workflows/R-CMD-check.yaml)
[![Project Status:
Concept](https://www.repostatus.org/badges/latest/active.svg)](https://www.repostatus.org/#active)
[![Codecov test
coverage](https://codecov.io/gh/ropensci-review-tools/roreviewapi/graph/badge.svg)](https://app.codecov.io/gh/ropensci-review-tools/roreviewapi)
<!-- badges: end -->
