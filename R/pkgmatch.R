...
pkgmatch_repo <- function (repourl, repo, issue_id, n_top = 5L, post_to_issue = TRUE) {
    ...
    if (!is.null (matches_cran) && !is.null (matches_ros)) {
        ...
        final_cmt <- paste0 (
            "Matches are generated by the ['pkgmatch' package](",
            "https://docs.ropensci.org/pkgmatch), based on inverse-term ",
            "frequencies; see the [main function documentation](",
            "https://docs.ropensci.org/pkgmatch/",
            "reference/pkgmatch_similar_pkgs.html) for details."
        )
