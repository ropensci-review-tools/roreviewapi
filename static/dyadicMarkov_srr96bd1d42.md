# srr report for [dyadicMarkov](https://github.com/BoellenruecherM/dyadicMarkov-public)
...
Standards in function ' bivariateCase() 'on line#334 of file [R/pkgcheck/dyadicMarkov-public/R/apim-bivariate.R](https://github.com/BoellenruecherM/dyadicMarkov-public/blob/ropensci-review-refinements/R/pkgcheck/dyadicMarkov-public/R/apim-bivariate.R#L334):
...
Standards on line#101 of file [R/pkgcheck/dyadicMarkov-public/R/dyadicMarkov-package.R](https://github.com/BoellenruecherM/dyadicMarkov-public/blob/ropensci-review-refinements/R/pkgcheck/dyadicMarkov-public/R/dyadicMarkov-package.R#L101):
...
Standards in function ' .cat_line() 'on line#14 of file [R/pkgcheck/dyadicMarkov-public/R/s3-methods.R](https://github.com/BoellenruecherM/dyadicMarkov-public/blob/ropensci-review-refinements/R/pkgcheck/dyadicMarkov-public/R/s3-methods.R#L14):
...
Standards on line#33 of file [R/pkgcheck/dyadicMarkov-public/R/srr-stats-standards.R](https://github.com/BoellenruecherM/dyadicMarkov-public/blob/ropensci-review-refinements/R/pkgcheck/dyadicMarkov-public/R/srr-stats-standards.R#L33):
...
Standards in function ' .validate_alpha() 'on line#26 of file [R/pkgcheck/dyadicMarkov-public/R/utils-validation.R](https://github.com/BoellenruecherM/dyadicMarkov-public/blob/ropensci-review-refinements/R/pkgcheck/dyadicMarkov-public/R/utils-validation.R#L26):
...
Standards on line#18 of file [tests/testthat/test-extended-sensitivity.R](https://github.com/BoellenruecherM/dyadicMarkov-public/blob/ropensci-review-refinements/tests/testthat/test-extended-sensitivity.R#L18):

- G5.4c Where applicable, stored values may be drawn from published paper outputs when applicable and where code from original implementations is not available

Standards on line#1 of file [tests/testthat/test-s3-matrix-classes.R](https://github.com/BoellenruecherM/dyadicMarkov-public/blob/ropensci-review-refinements/tests/testthat/test-s3-matrix-classes.R#L1):
...
Standards on line#5 of file [tests/testthat/test-s3-summary-tables.R](https://github.com/BoellenruecherM/dyadicMarkov-public/blob/ropensci-review-refinements/tests/testthat/test-s3-summary-tables.R#L5):
...
Standards on line#7 of file [tests/testthat/test-sequence-length-sensitivity.R](https://github.com/BoellenruecherM/dyadicMarkov-public/blob/ropensci-review-refinements/tests/testthat/test-sequence-length-sensitivity.R#L7):

- G5.7 *Algorithm performance tests** *to test that implementation performs as expected as properties of data change. For instance, a test may show that parameters approach correct estimates within tolerance as data size increases, or that convergence times decrease for higher convergence thresholds.

Standards on line#10 of file [tests/testthat/test-validation-errors.R](https://github.com/BoellenruecherM/dyadicMarkov-public/blob/ropensci-review-refinements/tests/testthat/test-validation-errors.R#L10):
...
Standards on line#77 of file [R/pkgcheck/dyadicMarkov-public/R/srr-stats-standards.R](https://github.com/BoellenruecherM/dyadicMarkov-public/blob/ropensci-review-refinements/R/pkgcheck/dyadicMarkov-public/R/srr-stats-standards.R#L77):
