# srr report for [rfastlowess](https://github.com/thisisamirv/lowess-project)
...
Standards on line#47 of file [bindings/r/R/pkgcheck/lowess-project/bindings/r/R/Lowess.R](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/R/pkgcheck/lowess-project/bindings/r/R/Lowess.R#L47):
...
Standards on line#23 of file [bindings/r/R/pkgcheck/lowess-project/bindings/r/R/OnlineLowess.R](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/R/pkgcheck/lowess-project/bindings/r/R/OnlineLowess.R#L23):

- G1.6 Software should include code necessary to compare performance claims with alternative implementations in other R packages.* 

- G2.0 Implement assertions on lengths of inputs, particularly through asserting that inputs expected to be single- or multi-valued are indeed so.

Standards on line#22 of file [bindings/r/R/pkgcheck/lowess-project/bindings/r/R/StreamingLowess.R](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/R/pkgcheck/lowess-project/bindings/r/R/StreamingLowess.R#L22):

- G1.6 Software should include code necessary to compare performance claims with alternative implementations in other R packages.* 

- G2.0 Implement assertions on lengths of inputs, particularly through asserting that inputs expected to be single- or multi-valued are indeed so.

Standards on line#14 of file [bindings/r/R/pkgcheck/lowess-project/bindings/r/R/methods.R](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/R/pkgcheck/lowess-project/bindings/r/R/methods.R#L14):
...
Standards on line#64 of file [bindings/r/R/pkgcheck/lowess-project/bindings/r/R/methods.R](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/R/pkgcheck/lowess-project/bindings/r/R/methods.R#L64):
...
Standards on line#37 of file [bindings/r/R/pkgcheck/lowess-project/bindings/r/R/rfastlowess-package.R](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/R/pkgcheck/lowess-project/bindings/r/R/rfastlowess-package.R#L37):
...
Standards on line#58 of file [bindings/r/R/pkgcheck/lowess-project/bindings/r/R/srr-stats-standards.R](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/R/pkgcheck/lowess-project/bindings/r/R/srr-stats-standards.R#L58):
...
Standards on line#27 of file [bindings/r/R/pkgcheck/lowess-project/bindings/r/R/utils.R](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/R/pkgcheck/lowess-project/bindings/r/R/utils.R#L27):
...
Standards on line#108 of file [bindings/r/R/pkgcheck/lowess-project/bindings/r/R/utils.R](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/R/pkgcheck/lowess-project/bindings/r/R/utils.R#L108):
...
Standards on line#7 of file [bindings/r/src/lib.rs](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/src/lib.rs#L7):
...
Standards on line#29 of file [bindings/r/vignettes/rfastlowess-intro.Rmd](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/vignettes/rfastlowess-intro.Rmd#L29):
...
### source manifest directories



Standards on line#11 of file [crates/lowess/src/adapters/batch.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/adapters/batch.rs#L11):

- G1.3 All statistical terminology should be clarified and unambiguously defined.* 

- G2.0 Implement assertions on lengths of inputs, particularly through asserting that inputs expected to be single- or multi-valued are indeed so.

Standards on line#11 of file [crates/lowess/src/adapters/online.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/adapters/online.rs#L11):

- G1.6 Software should include code necessary to compare performance claims with alternative implementations in other R packages.* 

- G2.1 Implement assertions on types of inputs (see the initial point on nomenclature above).

Standards on line#12 of file [crates/lowess/src/adapters/streaming.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/adapters/streaming.rs#L12):

- G1.6 Software should include code necessary to compare performance claims with alternative implementations in other R packages.* 

Standards on line#12 of file [crates/lowess/src/algorithms/interpolation.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/algorithms/interpolation.rs#L12):

- G1.6 Software should include code necessary to compare performance claims with alternative implementations in other R packages.* 

- RE2.2 Regression Software should provide different options for processing missing values in predictor and response data. For example, it should be possible to fit a model with no missing predictor data in order to generate values for all associated response points, even where submitted response values may be missing.

Standards on line#18 of file [crates/lowess/src/algorithms/regression.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/algorithms/regression.rs#L18):
...
Standards on line#13 of file [crates/lowess/src/algorithms/robustness.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/algorithms/robustness.rs#L13):
...
Standards on line#14 of file [crates/lowess/src/engine/executor.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/engine/executor.rs#L14):

- G2.2 Appropriately prohibit or restrict submission of multivariate input to parameters expected to be univariate.

- RE2.0 Regression Software should document any transformations applied to input data, for example conversion of label-values to `factor`, and should provide ways to explicitly avoid any default transformations (with error or warning conditions where appropriate).

Standards on line#12 of file [crates/lowess/src/engine/validator.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/engine/validator.rs#L12):
...
Standards on line#12 of file [crates/lowess/src/evaluation/cv.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/evaluation/cv.rs#L12):

- RE6.0 Model objects returned by Regression Software (see* **RE4***) should have default `plot` methods, either through explicit implementation, extension of methods for existing model objects, or through ensuring default methods work appropriately.

Standards on line#12 of file [crates/lowess/src/evaluation/diagnostics.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/evaluation/diagnostics.rs#L12):
...
Standards on line#11 of file [crates/lowess/src/evaluation/intervals.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/evaluation/intervals.rs#L11):

- RE5.0 Scaling relationships between sizes of input data (numbers of observations, with potential extension to numbers of variables/columns) and speed of algorithm.* 

Standards on line#229 of file [crates/lowess/src/lib.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/lib.rs#L229):
...
Standards on line#11 of file [crates/lowess/src/math/boundary.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/math/boundary.rs#L11):

- G2.1 Implement assertions on types of inputs (see the initial point on nomenclature above).

- RE2.0 Regression Software should document any transformations applied to input data, for example conversion of label-values to `factor`, and should provide ways to explicitly avoid any default transformations (with error or warning conditions where appropriate).

Standards on line#12 of file [crates/lowess/src/math/kernel.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/math/kernel.rs#L12):

- G1.2 Statistical Software should include a* Life Cycle Statement *describing current and anticipated future states of development.* 

Standards on line#10 of file [crates/lowess/src/primitives/sorting.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/primitives/sorting.rs#L10):

- G2.0 Implement assertions on lengths of inputs, particularly through asserting that inputs expected to be single- or multi-valued are indeed so.

Standards on line#10 of file [crates/lowess/src/primitives/window.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/lowess/src/primitives/window.rs#L10):

- G2.1 Implement assertions on types of inputs (see the initial point on nomenclature above).

- RE2.1 Regression Software should implement explicit parameters controlling the processing of missing values, ideally distinguishing `NA` or `NaN` values from `Inf` values (for example, through use of `na.omit()` and related functions from the `stats` package).* 

Standards on line#11 of file [crates/fastLowess/src/adapters/batch.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/fastLowess/src/adapters/batch.rs#L11):

- G1.5 Software should include all code necessary to reproduce results which form the basis of performance claims made in associated publications.* 

- G3.0 Statistical software should never compare floating point numbers for equality. All numeric equality comparisons should either ensure that they are made between integers, or use appropriate tolerances for approximate equality.* 

Standards on line#11 of file [crates/fastLowess/src/adapters/online.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/fastLowess/src/adapters/online.rs#L11):

- G1.6 Software should include code necessary to compare performance claims with alternative implementations in other R packages.* 

- G2.1 Implement assertions on types of inputs (see the initial point on nomenclature above).

Standards on line#12 of file [crates/fastLowess/src/adapters/streaming.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/fastLowess/src/adapters/streaming.rs#L12):

- G1.6 Software should include code necessary to compare performance claims with alternative implementations in other R packages.* 

- G3.0 Statistical software should never compare floating point numbers for equality. All numeric equality comparisons should either ensure that they are made between integers, or use appropriate tolerances for approximate equality.* 

Standards on line#13 of file [crates/fastLowess/src/engine/executor.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/fastLowess/src/engine/executor.rs#L13):
...
Standards on line#11 of file [crates/fastLowess/src/evaluation/cv.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/fastLowess/src/evaluation/cv.rs#L11):

- G3.0 Statistical software should never compare floating point numbers for equality. All numeric equality comparisons should either ensure that they are made between integers, or use appropriate tolerances for approximate equality.* 

- RE6.0 Model objects returned by Regression Software (see* **RE4***) should have default `plot` methods, either through explicit implementation, extension of methods for existing model objects, or through ensuring default methods work appropriately.

Standards on line#11 of file [crates/fastLowess/src/evaluation/intervals.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/fastLowess/src/evaluation/intervals.rs#L11):

- G3.0 Statistical software should never compare floating point numbers for equality. All numeric equality comparisons should either ensure that they are made between integers, or use appropriate tolerances for approximate equality.* 

- RE5.0 Scaling relationships between sizes of input data (numbers of observations, with potential extension to numbers of variables/columns) and speed of algorithm.* 

Standards on line#212 of file [crates/fastLowess/src/lib.rs](https://github.com/thisisamirv/lowess-project/blob/main/crates/fastLowess/src/lib.rs#L212):
...
Standards on line#33 of file [bindings/r/R/pkgcheck/lowess-project/bindings/r/R/srr-stats-standards.R](https://github.com/thisisamirv/lowess-project/blob/main/bindings/r/R/pkgcheck/lowess-project/bindings/r/R/srr-stats-standards.R#L33):
