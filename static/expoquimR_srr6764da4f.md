# srr report for [expoquimR](https://github.com/Aguilar-Elena/expoquimR)
...
Standards on line#227 of file [R/coshh.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/R/coshh.R#L227):
...
Standards on line#318 of file [R/from_excel.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/R/from_excel.R#L318):
...
Standards on line#555 of file [R/inrs.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/R/inrs.R#L555):
...
Standards on line#159 of file [R/plotting.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/R/plotting.R#L159):
...
Standards on line#125 of file [R/report.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/R/report.R#L125):
...
Standards on line#20 of file [R/srr-stats-standards.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/R/srr-stats-standards.R#L20):
...
Standards on line#320 of file [R/une689_estadistica.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/R/une689_estadistica.R#L320):

- G1.3 All statistical terminology should be clarified and unambiguously defined.* 

Standards on line#179 of file [R/une689_preliminar.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/R/une689_preliminar.R#L179):

- G2.0a Provide explicit secondary documentation of any expectations on lengths of inputs

- G3.0 Statistical software should never compare floating point numbers for equality. All numeric equality comparisons should either ensure that they are made between integers, or use appropriate tolerances for approximate equality.* 

Standards on line#260 of file [R/validation.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/R/validation.R#L260):
...
Standards on line#7 of file [tests/testthat/test-condition-messages.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/tests/testthat/test-condition-messages.R#L7):
...
Standards on line#5 of file [tests/testthat/test-coshh.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/tests/testthat/test-coshh.R#L5):

- G5.4 *Correctness tests** *to test that statistical algorithms produce expected results to some fixed test data sets (potentially through comparisons using binding frameworks such as [RStata](https://github.com/lbraglia/RStata)).

Standards on line#5 of file [tests/testthat/test-from-excel.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/tests/testthat/test-from-excel.R#L5):

- G5.1 Data sets created within, and used to test, a package should be exported (or otherwise made generally available) so that users can confirm tests and run examples.* 

Standards on line#6 of file [tests/testthat/test-plotting.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/tests/testthat/test-plotting.R#L6):
...
Standards on line#11 of file [tests/testthat/test-return-structures.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/tests/testthat/test-return-structures.R#L11):
...
Standards on line#12 of file [tests/testthat/test-validation.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/tests/testthat/test-validation.R#L12):
...
Standards on line#67 of file [R/srr-stats-standards.R](https://github.com/Aguilar-Elena/expoquimR/blob/main/R/srr-stats-standards.R#L67):
