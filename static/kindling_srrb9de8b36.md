# srr report for [kindling](https://github.com/joshuamarie/kindling)
...
Standards on line#34 of file [R/act-fun.R](https://github.com/joshuamarie/kindling/blob/main/R/act-fun.R#L34):

- G2.3a Use `match.arg()` or equivalent where applicable to only permit expected values.

Standards on line#13 of file [R/check-device.R](https://github.com/joshuamarie/kindling/blob/main/R/check-device.R#L13):

- G2.3a Use `match.arg()` or equivalent where applicable to only permit expected values.

- G2.3b Either: use `tolower()` or equivalent to ensure input of character parameters is not case dependent; or explicitly document that parameters are strictly case-sensitive.

Standards on line#12 of file [R/check-optimizer.R](https://github.com/joshuamarie/kindling/blob/main/R/check-optimizer.R#L12):

- G2.3a Use `match.arg()` or equivalent where applicable to only permit expected values.

Standards on line#39 of file [R/checks-input.R](https://github.com/joshuamarie/kindling/blob/main/R/checks-input.R#L39):
...
Standards on line#159 of file [R/checks-input.R](https://github.com/joshuamarie/kindling/blob/main/R/checks-input.R#L159):
...
Standards on line#20 of file [R/early_stop.R](https://github.com/joshuamarie/kindling/blob/main/R/early_stop.R#L20):

- G2.3a Use `match.arg()` or equivalent where applicable to only permit expected values.

Standards on line#136 of file [R/gen-train-nn-parsnip.R](https://github.com/joshuamarie/kindling/blob/main/R/gen-train-nn-parsnip.R#L136):
...
Standards on line#343 of file [R/generalized-nn-fit.R](https://github.com/joshuamarie/kindling/blob/main/R/generalized-nn-fit.R#L343):
...
Standards on line#726 of file [R/generalized-nn-fit.R](https://github.com/joshuamarie/kindling/blob/main/R/generalized-nn-fit.R#L726):
...
Standards on line#142 of file [R/kindling-package.R](https://github.com/joshuamarie/kindling/blob/main/R/kindling-package.R#L142):
...
Standards on line#111 of file [R/mlp_kindling.R](https://github.com/joshuamarie/kindling/blob/main/R/mlp_kindling.R#L111):

- ML3.0a A dedicated function should enable models to be specified without actually fitting or training them, or if this (**ML3**) and the following (**ML4**) stages are controlled by a single function, that function should have a parameter enabling models to be specified yet not fitted (for example, `nofit = FALSE`).

Standards on line#30 of file [R/plot.R](https://github.com/joshuamarie/kindling/blob/main/R/plot.R#L30):

- ML4.2 The subsequent extraction of information retained according to the preceding standard should be explicitly documented, including through example code.* 

Standards on line#13 of file [R/print-gen-nn.R](https://github.com/joshuamarie/kindling/blob/main/R/print-gen-nn.R#L13):
...
Standards on line#82 of file [R/print-nn-exec.R](https://github.com/joshuamarie/kindling/blob/main/R/print-nn-exec.R#L82):

- ML5.0b That class should have a defined `print` method which summarises important aspects of the model object, including but not limited to summaries of input data and algorithmic control parameters.

Standards on line#16 of file [R/regularizer.R](https://github.com/joshuamarie/kindling/blob/main/R/regularizer.R#L16):

- G3.0 Statistical software should never compare floating point numbers for equality. All numeric equality comparisons should either ensure that they are made between integers, or use appropriate tolerances for approximate equality.* 

Standards on line#67 of file [R/rnn_kindling.R](https://github.com/joshuamarie/kindling/blob/main/R/rnn_kindling.R#L67):

- ML3.0a A dedicated function should enable models to be specified without actually fitting or training them, or if this (**ML3**) and the following (**ML4**) stages are controlled by a single function, that function should have a parameter enabling models to be specified yet not fitted (for example, `nofit = FALSE`).

Standards on line#70 of file [R/save-load.R](https://github.com/joshuamarie/kindling/blob/main/R/save-load.R#L70):
...
Standards on line#64 of file [R/srr-stats-standards.R](https://github.com/joshuamarie/kindling/blob/main/R/srr-stats-standards.R#L64):
...
Standards on line#5 of file [tests/testthat/test-basemodel-w-optim.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-basemodel-w-optim.R#L5):
...
Standards on line#5 of file [tests/testthat/test-basemodel.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-basemodel.R#L5):

- G5.0 Where applicable or practicable, tests should use standard data sets with known properties (for example, the [NIST Standard Reference Datasets](https://www.itl.nist.gov/div898/strd/), or data sets provided by other widely-used R packages).

Standards on line#4 of file [tests/testthat/test-plot.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-plot.R#L4):

- ML4.2 The subsequent extraction of information retained according to the preceding standard should be explicitly documented, including through example code.* 

Standards on line#4 of file [tests/testthat/test-prints.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-prints.R#L4):

- ML5.0b That class should have a defined `print` method which summarises important aspects of the model object, including but not limited to summaries of input data and algorithmic control parameters.

Standards on line#35 of file [tests/testthat/test-srr-correctness.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-srr-correctness.R#L35):
...
Standards on line#8 of file [tests/testthat/test-srr-extended.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-srr-extended.R#L8):
...
Standards on line#27 of file [tests/testthat/test-srr-input-checks.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-srr-input-checks.R#L27):
...
Standards on line#13 of file [tests/testthat/test-srr-messages.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-srr-messages.R#L13):

- G5.2b Explicit tests should demonstrate conditions which trigger every one of those messages, and should compare the result with expected values.

Standards on line#14 of file [tests/testthat/test-srr-model-comparison.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-srr-model-comparison.R#L14):
...
Standards on line#20 of file [tests/testthat/test-srr-save-load.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-srr-save-load.R#L20):
...
Standards on line#5 of file [tests/testthat/test-train-nn.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-train-nn.R#L5):
...
Standards on line#7 of file [tests/testthat/test-yardstick-integration.R](https://github.com/joshuamarie/kindling/blob/main/tests/testthat/test-yardstick-integration.R#L7):
...
Standards on line#179 of file [R/srr-stats-standards.R](https://github.com/joshuamarie/kindling/blob/main/R/srr-stats-standards.R#L179):
