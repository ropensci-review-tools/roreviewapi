...
Standards on line#24 of file [R/partialling.out-package.R](https://marcboschmatas.github.io/partialling.out//blob/main/R/partialling.out-package.R#L24):
...
Standards on line#72 of file [R/partialling_out.R](https://marcboschmatas.github.io/partialling.out//blob/main/R/partialling_out.R#L72):
...
Standards on line#24 of file [R/prepare_formula.R](https://marcboschmatas.github.io/partialling.out//blob/main/R/prepare_formula.R#L24):
...
Standards on line#22 of file [inst/tinytest/test_partialling.out.R](https://marcboschmatas.github.io/partialling.out//blob/main/inst/tinytest/test_partialling.out.R#L22):
...
Standards on line#32 of file [inst/tinytest/test_partialling.out.R](https://marcboschmatas.github.io/partialling.out//blob/main/inst/tinytest/test_partialling.out.R#L32):
...
Standards on line#197 of file [inst/tinytest/test_partialling.out.R](https://marcboschmatas.github.io/partialling.out//blob/main/inst/tinytest/test_partialling.out.R#L197):
...
Standards on line#430 of file [inst/tinytest/test_partialling.out.R](https://marcboschmatas.github.io/partialling.out//blob/main/inst/tinytest/test_partialling.out.R#L430):
...
Standards on line#483 of file [inst/tinytest/test_partialling.out.R](https://marcboschmatas.github.io/partialling.out//blob/main/inst/tinytest/test_partialling.out.R#L483):

- G2.7 Software should accept as input as many of the above standard tabular forms as possible, including extension to domain-specific forms.* 

Standards on line#521 of file [inst/tinytest/test_partialling.out.R](https://marcboschmatas.github.io/partialling.out//blob/main/inst/tinytest/test_partialling.out.R#L521):

- G2.11 Software should ensure that `data.frame`-like tabular objects which have columns which do not themselves have standard class attributes (typically, `vector`) are appropriately processed, and do not error without reason. This behaviour should be tested. Again, columns created by the [`units` package](https://github.com/r-quantities/units/) provide a good test case.

Standards on line#540 of file [inst/tinytest/test_partialling.out.R](https://marcboschmatas.github.io/partialling.out//blob/main/inst/tinytest/test_partialling.out.R#L540):

- G2.12 Software should ensure that `data.frame`-like tabular objects which have list columns should ensure that those columns are appropriately pre-processed either through being removed, converted to equivalent vector columns where appropriate, or some other appropriate treatment such as an informative error. This behaviour should be tested.* 

Standards on line#603 of file [inst/tinytest/test_partialling.out.R](https://marcboschmatas.github.io/partialling.out//blob/main/inst/tinytest/test_partialling.out.R#L603):
...
Standards on line#755 of file [inst/tinytest/test_partialling.out.R](https://marcboschmatas.github.io/partialling.out//blob/main/inst/tinytest/test_partialling.out.R#L755):
...
Standards on line#90 of file [R/srr-stats-standards.R](https://marcboschmatas.github.io/partialling.out//blob/main/R/srr-stats-standards.R#L90):
