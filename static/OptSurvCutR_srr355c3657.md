...
Standards on line#19 of file [R/pkgcheck/OptSurvCutR/R/OptSurvCutR-package.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/OptSurvCutR-package.R#L19):
...
Standards on line#41 of file [R/pkgcheck/OptSurvCutR/R/engine-genetic.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/engine-genetic.R#L41):
...
Standards on line#150 of file [R/pkgcheck/OptSurvCutR/R/engine-genetic.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/engine-genetic.R#L150):
...
Standards on line#258 of file [R/pkgcheck/OptSurvCutR/R/engine-genetic.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/engine-genetic.R#L258):

- G1.4a All internal (non-exported) functions should also be documented in standard [`roxygen2`](https://roxygen2.r-lib.org/) format, along with a final `@noRd` tag to suppress automatic generation of `.Rd` files or [`@keywords internal`](https://roxygen2.r-lib.org/reference/tags-index-crossref.html?q=keywords%20internal#null) if documentation is still desired.* 

- RE4.11 Goodness-of-fit and other statistics associated such as effect sizes with model coefficients.

Standards on line#30 of file [R/pkgcheck/OptSurvCutR/R/engine-systematic.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/engine-systematic.R#L30):
...
Standards on line#173 of file [R/pkgcheck/OptSurvCutR/R/engine-systematic.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/engine-systematic.R#L173):

- G1.4a All internal (non-exported) functions should also be documented in standard [`roxygen2`](https://roxygen2.r-lib.org/) format, along with a final `@noRd` tag to suppress automatic generation of `.Rd` files or [`@keywords internal`](https://roxygen2.r-lib.org/reference/tags-index-crossref.html?q=keywords%20internal#null) if documentation is still desired.* 

- RE1.0 Regression Software should enable models to be specified via a formula interface, unless reasons for not doing so are explicitly documented.

Standards on line#251 of file [R/pkgcheck/OptSurvCutR/R/engine-systematic.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/engine-systematic.R#L251):
...
Standards on line#343 of file [R/pkgcheck/OptSurvCutR/R/engine-systematic.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/engine-systematic.R#L343):
...
Standards on line#137 of file [R/pkgcheck/OptSurvCutR/R/find_cutpoint.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/find_cutpoint.R#L137):
...
Standards on line#13 of file [R/pkgcheck/OptSurvCutR/R/find_cutpoint_methods.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/find_cutpoint_methods.R#L13):
...
Standards on line#84 of file [R/pkgcheck/OptSurvCutR/R/find_cutpoint_methods.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/find_cutpoint_methods.R#L84):
...
Standards on line#113 of file [R/pkgcheck/OptSurvCutR/R/find_cutpoint_number.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/find_cutpoint_number.R#L113):
...
Standards on line#440 of file [R/pkgcheck/OptSurvCutR/R/find_cutpoint_number.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/find_cutpoint_number.R#L440):
...
Standards on line#13 of file [R/pkgcheck/OptSurvCutR/R/find_cutpoint_number_methods.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/find_cutpoint_number_methods.R#L13):

- RE4.17 Model objects returned by Regression Software should implement or appropriately extend a default `print` method which provides an on-screen summary of model (input) parameters and (output) coefficients.

Standards on line#95 of file [R/pkgcheck/OptSurvCutR/R/find_cutpoint_number_methods.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/find_cutpoint_number_methods.R#L95):
...
Standards on line#306 of file [R/pkgcheck/OptSurvCutR/R/find_cutpoint_number_methods.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/find_cutpoint_number_methods.R#L306):

- RE6.0 Model objects returned by Regression Software (see* **RE4***) should have default `plot` methods, either through explicit implementation, extension of methods for existing model objects, or through ensuring default methods work appropriately.

- RE6.2 The default `plot` method should produce a plot of the `fitted` values of the model, with optional visualisation of confidence intervals or equivalent.* 

Standards on line#16 of file [R/pkgcheck/OptSurvCutR/R/globals.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/globals.R#L16):

- G1.4a All internal (non-exported) functions should also be documented in standard [`roxygen2`](https://roxygen2.r-lib.org/) format, along with a final `@noRd` tag to suppress automatic generation of `.Rd` files or [`@keywords internal`](https://roxygen2.r-lib.org/reference/tags-index-crossref.html?q=keywords%20internal#null) if documentation is still desired.* 

Standards on line#83 of file [R/pkgcheck/OptSurvCutR/R/plotting_functions.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/plotting_functions.R#L83):

- RE6.0 Model objects returned by Regression Software (see* **RE4***) should have default `plot` methods, either through explicit implementation, extension of methods for existing model objects, or through ensuring default methods work appropriately.

- RE6.1 Where the default `plot` method is **NOT** a generic `plot` method dispatched on the class of return objects (that is, through an S3-type `plot.<myclass>` function or equivalent), that method dispatch (or equivalent) should nevertheless exist in order to explicitly direct users to the appropriate function.

Standards on line#158 of file [R/pkgcheck/OptSurvCutR/R/plotting_functions.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/plotting_functions.R#L158):

- RE6.2 The default `plot` method should produce a plot of the `fitted` values of the model, with optional visualisation of confidence intervals or equivalent.* 

Standards on line#614 of file [R/pkgcheck/OptSurvCutR/R/plotting_functions.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/plotting_functions.R#L614):

- RE4.11 Goodness-of-fit and other statistics associated such as effect sizes with model coefficients.

Standards on line#37 of file [R/pkgcheck/OptSurvCutR/R/utils-helpers.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/utils-helpers.R#L37):

- G1.4a All internal (non-exported) functions should also be documented in standard [`roxygen2`](https://roxygen2.r-lib.org/) format, along with a final `@noRd` tag to suppress automatic generation of `.Rd` files or [`@keywords internal`](https://roxygen2.r-lib.org/reference/tags-index-crossref.html?q=keywords%20internal#null) if documentation is still desired.* 

- RE4.11 Goodness-of-fit and other statistics associated such as effect sizes with model coefficients.

Standards on line#81 of file [R/pkgcheck/OptSurvCutR/R/utils-helpers.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/utils-helpers.R#L81):

- G2.0a Provide explicit secondary documentation of any expectations on lengths of inputs

Standards on line#151 of file [R/pkgcheck/OptSurvCutR/R/utils-helpers.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/utils-helpers.R#L151):
...
Standards on line#177 of file [R/pkgcheck/OptSurvCutR/R/utils-helpers.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/utils-helpers.R#L177):
...
Standards on line#216 of file [R/pkgcheck/OptSurvCutR/R/utils-helpers.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/utils-helpers.R#L216):
...
Standards on line#281 of file [R/pkgcheck/OptSurvCutR/R/utils-helpers.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/utils-helpers.R#L281):

- G2.0 Implement assertions on lengths of inputs, particularly through asserting that inputs expected to be single- or multi-valued are indeed so.

- G2.1 Implement assertions on types of inputs (see the initial point on nomenclature above).

Standards on line#94 of file [R/pkgcheck/OptSurvCutR/R/validate_cutpoint.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/validate_cutpoint.R#L94):
...
Standards on line#11 of file [R/pkgcheck/OptSurvCutR/R/validate_cutpoint_methods.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/validate_cutpoint_methods.R#L11):

- RE4.17 Model objects returned by Regression Software should implement or appropriately extend a default `print` method which provides an on-screen summary of model (input) parameters and (output) coefficients.

Standards on line#43 of file [R/pkgcheck/OptSurvCutR/R/validate_cutpoint_methods.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/validate_cutpoint_methods.R#L43):

- RE6.0 Model objects returned by Regression Software (see* **RE4***) should have default `plot` methods, either through explicit implementation, extension of methods for existing model objects, or through ensuring default methods work appropriately.

Standards on line#98 of file [R/pkgcheck/OptSurvCutR/R/validate_cutpoint_methods.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/validate_cutpoint_methods.R#L98):
...
Standards on line#34 of file [tests/testthat/test-find_cutpoint.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-find_cutpoint.R#L34):
...
Standards on line#49 of file [tests/testthat/test-find_cutpoint.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-find_cutpoint.R#L49):

- G5.4a For new methods, it can be difficult to separate out correctness of the method from the correctness of the implementation, as there may not be reference for comparison. In this case, testing may be implemented against simple, trivial cases or against multiple implementations such as an initial R implementation compared with results from a C/C++ implementation.

Standards on line#65 of file [tests/testthat/test-find_cutpoint.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-find_cutpoint.R#L65):

- RE1.0 Regression Software should enable models to be specified via a formula interface, unless reasons for not doing so are explicitly documented.

- RE1.1 Regression Software should document how formula interfaces are converted to matrix representations of input data.* 

Standards on line#104 of file [tests/testthat/test-find_cutpoint.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-find_cutpoint.R#L104):

- G5.2b Explicit tests should demonstrate conditions which trigger every one of those messages, and should compare the result with expected values.

Standards on line#49 of file [tests/testthat/test-plotting.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-plotting.R#L49):

- G5.2b Explicit tests should demonstrate conditions which trigger every one of those messages, and should compare the result with expected values.

Standards on line#91 of file [tests/testthat/test-plotting.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-plotting.R#L91):

- RE6.0 Model objects returned by Regression Software (see* **RE4***) should have default `plot` methods, either through explicit implementation, extension of methods for existing model objects, or through ensuring default methods work appropriately.

- RE6.1 Where the default `plot` method is **NOT** a generic `plot` method dispatched on the class of return objects (that is, through an S3-type `plot.<myclass>` function or equivalent), that method dispatch (or equivalent) should nevertheless exist in order to explicitly direct users to the appropriate function.

Standards on line#162 of file [tests/testthat/test-plotting.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-plotting.R#L162):

- RE6.2 The default `plot` method should produce a plot of the `fitted` values of the model, with optional visualisation of confidence intervals or equivalent.* 

Standards on line#14 of file [tests/testthat/test-srr-metadata.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-srr-metadata.R#L14):
...
Standards on line#33 of file [tests/testthat/test-utils.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-utils.R#L33):
...
Standards on line#68 of file [tests/testthat/test-utils.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-utils.R#L68):
...
Standards on line#89 of file [tests/testthat/test-utils.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-utils.R#L89):

- G2.1 Implement assertions on types of inputs (see the initial point on nomenclature above).

- G5.2b Explicit tests should demonstrate conditions which trigger every one of those messages, and should compare the result with expected values.

Standards on line#110 of file [tests/testthat/test-utils.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-utils.R#L110):

- G2.9 Software should issue diagnostic messages for type conversion in which information is lost (such as conversion of variables from factor to character; standardisation of variable names; or removal of meta-data such as those associated with [`sf`-format](https://r-spatial.github.io/sf/) data) or added (such as insertion of variable or column names where none were provided).* 

- G5.2a Every message produced within R code by `stop()`, `warning()`, `message()`, or equivalent should be unique

Standards on line#7 of file [tests/testthat/test-validate_cutpoint.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-validate_cutpoint.R#L7):

- G5.6b Parameter recovery tests should be run with multiple random seeds when either data simulation or the algorithm contains a random component. (When long-running, such tests may be part of an extended, rather than regular, test suite; see G5.10-4.12, below).* 

Standards on line#26 of file [tests/testthat/test-validate_cutpoint.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-validate_cutpoint.R#L26):

- G5.2b Explicit tests should demonstrate conditions which trigger every one of those messages, and should compare the result with expected values.

Standards on line#69 of file [tests/testthat/test-validate_cutpoint.R](https://github.com/paytonyau/OptSurvCutR/blob/main/tests/testthat/test-validate_cutpoint.R#L69):
...
Standards on line#130 of file [R/pkgcheck/OptSurvCutR/R/OptSurvCutR-package.R](https://github.com/paytonyau/OptSurvCutR/blob/main/R/pkgcheck/OptSurvCutR/R/OptSurvCutR-package.R#L130):
