...
Standards in function ' Lowess() 'on line#47 of file [R/pkgcheck/lowess-project/bindings/r/R/Lowess.R](https://github.com/thisisamirv/lowess-project/blob/main/R/pkgcheck/lowess-project/bindings/r/R/Lowess.R#L47):
...
Standards in function ' OnlineLowess() 'on line#33 of file [R/pkgcheck/lowess-project/bindings/r/R/OnlineLowess.R](https://github.com/thisisamirv/lowess-project/blob/main/R/pkgcheck/lowess-project/bindings/r/R/OnlineLowess.R#L33):

- G1.6 Software should include code necessary to compare performance claims with alternative implementations in other R packages.* 

- G2.0 Implement assertions on lengths of inputs, particularly through asserting that inputs expected to be single- or multi-valued are indeed so.

Standards in function ' StreamingLowess() 'on line#33 of file [R/pkgcheck/lowess-project/bindings/r/R/StreamingLowess.R](https://github.com/thisisamirv/lowess-project/blob/main/R/pkgcheck/lowess-project/bindings/r/R/StreamingLowess.R#L33):

- G1.6 Software should include code necessary to compare performance claims with alternative implementations in other R packages.* 

- G2.0 Implement assertions on lengths of inputs, particularly through asserting that inputs expected to be single- or multi-valued are indeed so.

Standards in function ' print.Lowess() 'on line#14 of file [R/pkgcheck/lowess-project/bindings/r/R/methods.R](https://github.com/thisisamirv/lowess-project/blob/main/R/pkgcheck/lowess-project/bindings/r/R/methods.R#L14):
...
Standards in function ' plot.LowessResult() 'on line#64 of file [R/pkgcheck/lowess-project/bindings/r/R/methods.R](https://github.com/thisisamirv/lowess-project/blob/main/R/pkgcheck/lowess-project/bindings/r/R/methods.R#L64):
...
Standards on line#36 of file [R/pkgcheck/lowess-project/bindings/r/R/rfastlowess-package.R](https://github.com/thisisamirv/lowess-project/blob/main/R/pkgcheck/lowess-project/bindings/r/R/rfastlowess-package.R#L36):
...
Standards on line#58 of file [R/pkgcheck/lowess-project/bindings/r/R/srr-stats-standards.R](https://github.com/thisisamirv/lowess-project/blob/main/R/pkgcheck/lowess-project/bindings/r/R/srr-stats-standards.R#L58):
...
Standards in function ' validate_common_args() 'on line#26 of file [R/pkgcheck/lowess-project/bindings/r/R/utils.R](https://github.com/thisisamirv/lowess-project/blob/main/R/pkgcheck/lowess-project/bindings/r/R/utils.R#L26):
...
Standards in function ' coerce_nullable() 'on line#86 of file [R/pkgcheck/lowess-project/bindings/r/R/utils.R](https://github.com/thisisamirv/lowess-project/blob/main/R/pkgcheck/lowess-project/bindings/r/R/utils.R#L86):
...
Standards on line#29 of file [vignettes/rfastlowess-intro.Rmd](https://github.com/thisisamirv/lowess-project/blob/main/vignettes/rfastlowess-intro.Rmd#L29):
...
Standards on line#33 of file [R/pkgcheck/lowess-project/bindings/r/R/srr-stats-standards.R](https://github.com/thisisamirv/lowess-project/blob/main/R/pkgcheck/lowess-project/bindings/r/R/srr-stats-standards.R#L33):
