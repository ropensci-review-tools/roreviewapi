# srr report for [GLMMcosinor](https://github.com/RWParsons/GLMMcosinor)
...
Standards in function 'amp_acro()' on line#61 of file [R/amp_acro.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/amp_acro.R#L61):
...
Standards in function '.amp_acro()' on line#108 of file [R/amp_acro.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/amp_acro.R#L108):
...
Standards in function 'autoplot.cosinor.glmm()' on line#54 of file [R/autoplot.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/autoplot.R#L54):
...
Standards in function 'cosinor.glmm()' on line#69 of file [R/cosinor.glmm.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/cosinor.glmm.R#L69):
...
Standards in function 'get_varnames()' on line#107 of file [R/cosinor.glmm.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/cosinor.glmm.R#L107):

- G1.4a All internal (non-exported) functions should also be documented in standard [`roxygen2`](https://roxygen2.r-lib.org/) format, along with a final `@noRd` tag to suppress automatic generation of `.Rd` files.* 

Standards in function 'fit_model_and_process()' on line#44 of file [R/data_processor.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/data_processor.R#L44):

- G1.4 Software should use [`roxygen2`](https://roxygen2.r-lib.org/) to document all functions.

Standards in function 'data_processor()' on line#106 of file [R/data_processor.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/data_processor.R#L106):
...
Standards in function 'update_formula_and_data()' on line#56 of file [R/data_utils.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/data_utils.R#L56):
...
Standards in function 'check_group_var()' on line#167 of file [R/data_utils.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/data_utils.R#L167):

- G1.4a All internal (non-exported) functions should also be documented in standard [`roxygen2`](https://roxygen2.r-lib.org/) format, along with a final `@noRd` tag to suppress automatic generation of `.Rd` files.* 

Standards in function 'validate_ci_level()' on line#186 of file [R/data_utils.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/data_utils.R#L186):

- G1.4a All internal (non-exported) functions should also be documented in standard [`roxygen2`](https://roxygen2.r-lib.org/) format, along with a final `@noRd` tag to suppress automatic generation of `.Rd` files.* 

Standards in function 'polar_plot()' on line#79 of file [R/polar_plot.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/polar_plot.R#L79):

- G1.4 Software should use [`roxygen2`](https://roxygen2.r-lib.org/) to document all functions.

Standards in function 'polar_plot.cosinor.glmm()' on line#177 of file [R/polar_plot.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/polar_plot.R#L177):

- G1.4 Software should use [`roxygen2`](https://roxygen2.r-lib.org/) to document all functions.

Standards in function 'predict.cosinor.glmm()' on line#28 of file [R/predict.cosinor.glmm.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/predict.cosinor.glmm.R#L28):

- G1.4 Software should use [`roxygen2`](https://roxygen2.r-lib.org/) to document all functions.

- RE4.9 Modelled values of response variables.

Standards in function 'print.cosinor.glmm()' on line#19 of file [R/print.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/print.R#L19):
...
Standards in function 'simulate_cosinor()' on line#66 of file [R/simulate_cosinor.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/simulate_cosinor.R#L66):

- G5.1 Data sets created within, and used to test, a package should be exported (or otherwise made generally available) so that users can confirm tests and run examples.* 

Standards in  on line#89 of file [R/srr-stats-standards.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/srr-stats-standards.R#L89):
...
Standards in function 'summary.cosinor.glmm()' on line#31 of file [R/summary.cosinor.glmm.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/summary.cosinor.glmm.R#L31):

- G1.4 Software should use [`roxygen2`](https://roxygen2.r-lib.org/) to document all functions.

- RE4.18 Regression Software may also implement `summary` methods for model objects, and in particular should implement distinct `summary` methods for any cases in which calculation of summary statistics is computationally non-trivial (for example, for bootstrapped estimates of confidence intervals).* 

Standards in function 'print.summary.cosinor.glmm()' on line#263 of file [R/summary.cosinor.glmm.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/summary.cosinor.glmm.R#L263):
...
Standards in  on line#8 of file [tests/testthat/test-amp-acro.R](https://github.com/RWParsons/GLMMcosinor/blob/main/tests/testthat/test-amp-acro.R#L8):
...
Standards in  on line#8 of file [tests/testthat/test-autoplot.R](https://github.com/RWParsons/GLMMcosinor/blob/main/tests/testthat/test-autoplot.R#L8):
...
Standards in  on line#17 of file [tests/testthat/test-cosinor.R](https://github.com/RWParsons/GLMMcosinor/blob/main/tests/testthat/test-cosinor.R#L17):
...
Standards in  on line#206 of file [tests/testthat/test-cosinor.R](https://github.com/RWParsons/GLMMcosinor/blob/main/tests/testthat/test-cosinor.R#L206):

- RE7.2 Demonstrate that output objects retain aspects of input data such as row or case names (see **RE1.3**).

- RE7.3 Demonstrate and test expected behaviour when objects returned from regression software are submitted to the accessor methods of **RE4.2**--**RE4.7**.

Standards in  on line#7 of file [tests/testthat/test-simulate_cosinor.R](https://github.com/RWParsons/GLMMcosinor/blob/main/tests/testthat/test-simulate_cosinor.R#L7):
...
Standards in  on line#8 of file [tests/testthat/test-test_cosinor.R](https://github.com/RWParsons/GLMMcosinor/blob/main/tests/testthat/test-test_cosinor.R#L8):
...
Standards in  on line#8 of file [tests/testthat/test-update_formula_and_data.R](https://github.com/RWParsons/GLMMcosinor/blob/main/tests/testthat/test-update_formula_and_data.R#L8):
...
Standards in  on line#22 of file [./README.Rmd](https://github.com/RWParsons/GLMMcosinor/blob/main/./README.Rmd#L22):
...
Standards in  on line#165 of file [R/srr-stats-standards.R](https://github.com/RWParsons/GLMMcosinor/blob/main/R/srr-stats-standards.R#L165):
