...
Standards on line#84 of file [R/ernest_sampler.R](https://github.com/kylesnap/ernest/issues//blob/main/R/ernest_sampler.R#L84):
...
Standards on line#86 of file [R/generate.R](https://github.com/kylesnap/ernest/issues//blob/main/R/generate.R#L86):

- BS2.12 Bayesian Software should implement at least one parameter controlling the verbosity of output, defaulting to verbose output of all appropriate messages, warnings, errors, and progress indicators.

- BS4.0 Packages should document sampling algorithms (generally via literary citation, or reference to other software)

Standards on line#122 of file [R/generate.R](https://github.com/kylesnap/ernest/issues//blob/main/R/generate.R#L122):

- BS2.8 Enable results of previous runs to be used as starting points for subsequent runs.* 

Standards on line#66 of file [R/likelihood-class.R](https://github.com/kylesnap/ernest/issues//blob/main/R/likelihood-class.R#L66):
...
Standards on line#87 of file [R/likelihood-class.R](https://github.com/kylesnap/ernest/issues//blob/main/R/likelihood-class.R#L87):
...
Standards on line#39 of file [R/nested_sampling_impl.R](https://github.com/kylesnap/ernest/issues//blob/main/R/nested_sampling_impl.R#L39):
...
Standards on line#73 of file [R/prior-class.R](https://github.com/kylesnap/ernest/issues//blob/main/R/prior-class.R#L73):
...
Standards on line#180 of file [R/prior-class.R](https://github.com/kylesnap/ernest/issues//blob/main/R/prior-class.R#L180):
...
Standards on line#116 of file [R/run-class.R](https://github.com/kylesnap/ernest/issues//blob/main/R/run-class.R#L116):

- BS6.0 Software should implement a default `print` method for return objects

Standards on line#171 of file [R/run-class.R](https://github.com/kylesnap/ernest/issues//blob/main/R/run-class.R#L171):

- BS6.4 Software may provide `summary` methods for return objects

Standards on line#69 of file [R/rwmh_cube.R](https://github.com/kylesnap/ernest/issues//blob/main/R/rwmh_cube.R#L69):

- BS4.0 Packages should document sampling algorithms (generally via literary citation, or reference to other software)

Standards on line#111 of file [R/rwmh_cube.R](https://github.com/kylesnap/ernest/issues//blob/main/R/rwmh_cube.R#L111):
...
Standards on line#92 of file [R/slice_rectangle.R](https://github.com/kylesnap/ernest/issues//blob/main/R/slice_rectangle.R#L92):
...
Standards on line#54 of file [R/unif_cube.R](https://github.com/kylesnap/ernest/issues//blob/main/R/unif_cube.R#L54):
...
Standards on line#23 of file [R/utils.R](https://github.com/kylesnap/ernest/issues//blob/main/R/utils.R#L23):
...
Standards on line#13 of file [tests/testthat/helper_algorithm-tests.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/helper_algorithm-tests.R#L13):

- BS4.1 Packages should provide explicit comparisons with external samplers which demonstrate intended advantage of implementation (generally via tests, vignettes, or both).* 

Standards on line#107 of file [tests/testthat/helper_algorithm-tests.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/helper_algorithm-tests.R#L107):
...
Standards on line#15 of file [tests/testthat/test-algorithm.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-algorithm.R#L15):
...
Standards on line#44 of file [tests/testthat/test-algorithm.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-algorithm.R#L44):
...
Standards on line#55 of file [tests/testthat/test-algorithm.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-algorithm.R#L55):
...
Standards on line#39 of file [tests/testthat/test-compile.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-compile.R#L39):
...
Standards on line#67 of file [tests/testthat/test-edgecases.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-edgecases.R#L67):
...
Standards on line#109 of file [tests/testthat/test-edgecases.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-edgecases.R#L109):

- G5.8d Data outside the scope of the algorithm (for example, data with more fields (columns) than observations (rows) for some regression algorithms)

Standards on line#19 of file [tests/testthat/test-ernest_sampler.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-ernest_sampler.R#L19):
...
Standards on line#6 of file [tests/testthat/test-lrps-class.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-lrps-class.R#L6):
...
Standards on line#6 of file [tests/testthat/test-mini_balls.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-mini_balls.R#L6):
...
Standards on line#6 of file [tests/testthat/test-no_underrun.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-no_underrun.R#L6):
...
Standards on line#35 of file [tests/testthat/test-p_recovery.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-p_recovery.R#L35):
...
Standards on line#6 of file [tests/testthat/test-rwmh_cube.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-rwmh_cube.R#L6):
...
Standards on line#6 of file [tests/testthat/test-slice_rectangle.R](https://github.com/kylesnap/ernest/issues//blob/main/tests/testthat/test-slice_rectangle.R#L6):
...
Standards on line#56 of file [R/srr-stats-standards.R](https://github.com/kylesnap/ernest/issues//blob/main/R/srr-stats-standards.R#L56):
