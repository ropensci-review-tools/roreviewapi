# srr report for [corila](https://github.com/rauschenberger/corila)
...
Standards on line#196 of file [R/group_lasso.R](https://github.com/rauschenberger/corila/blob/main/R/group_lasso.R#L196):
...
Standards on line#120 of file [R/group_ridge.R](https://github.com/rauschenberger/corila/blob/main/R/group_ridge.R#L120):

- G1.0 Statistical Software should list at least one primary reference from published academic literature.* 

- G1.1 Statistical Software should document whether the algorithm(s) it implements are:* - *The first implementation of a novel algorithm*; or - *The first implementation within **R** of an algorithm which has previously been implemented in other languages or contexts*; or - *An improvement on other implementations of similar algorithms in **R***. 

Standards on line#114 of file [R/helpers.R](https://github.com/rauschenberger/corila/blob/main/R/helpers.R#L114):
...
Standards on line#104 of file [R/methods.R](https://github.com/rauschenberger/corila/blob/main/R/methods.R#L104):

- RE4.2 Model coefficients (via `coef()` / `coefficients()`)

Standards on line#229 of file [R/methods.R](https://github.com/rauschenberger/corila/blob/main/R/methods.R#L229):

- RE4.9 Modelled values of response variables.

Standards on line#257 of file [R/methods.R](https://github.com/rauschenberger/corila/blob/main/R/methods.R#L257):
...
Standards on line#294 of file [R/methods.R](https://github.com/rauschenberger/corila/blob/main/R/methods.R#L294):
...
Standards on line#354 of file [R/methods.R](https://github.com/rauschenberger/corila/blob/main/R/methods.R#L354):
...
Standards on line#405 of file [R/methods.R](https://github.com/rauschenberger/corila/blob/main/R/methods.R#L405):
...
Standards on line#477 of file [R/methods.R](https://github.com/rauschenberger/corila/blob/main/R/methods.R#L477):

- RE4.11 Goodness-of-fit and other statistics associated such as effect sizes with model coefficients.

Standards on line#505 of file [R/methods.R](https://github.com/rauschenberger/corila/blob/main/R/methods.R#L505):

- RE4.5 Numbers of observations submitted to model (via `nobs()`)

Standards on line#56 of file [R/pkgname.R](https://github.com/rauschenberger/corila/blob/main/R/pkgname.R#L56):

- G1.0 Statistical Software should list at least one primary reference from published academic literature.* 

- G1.1 Statistical Software should document whether the algorithm(s) it implements are:* - *The first implementation of a novel algorithm*; or - *The first implementation within **R** of an algorithm which has previously been implemented in other languages or contexts*; or - *An improvement on other implementations of similar algorithms in **R***. 

Standards on line#131 of file [R/simulate.R](https://github.com/rauschenberger/corila/blob/main/R/simulate.R#L131):

- G5.1 Data sets created within, and used to test, a package should be exported (or otherwise made generally available) so that users can confirm tests and run examples.* 

Standards on line#17 of file [R/srr_stats_standards.R](https://github.com/rauschenberger/corila/blob/main/R/srr_stats_standards.R#L17):
...
Standards on line#46 of file [R/validate.R](https://github.com/rauschenberger/corila/blob/main/R/validate.R#L46):
...
Standards on line#9 of file [tests/testthat/test-group_lasso.R](https://github.com/rauschenberger/corila/blob/main/tests/testthat/test-group_lasso.R#L9):
...
Standards on line#10 of file [tests/testthat/test-group_lasso.R](https://github.com/rauschenberger/corila/blob/main/tests/testthat/test-group_lasso.R#L10):
...
Standards on line#7 of file [tests/testthat/test-helpers.R](https://github.com/rauschenberger/corila/blob/main/tests/testthat/test-helpers.R#L7):

- G5.3 For functions which are expected to return objects containing no missing (`NA`) or undefined (`NaN`, `Inf`) values, the absence of any such values in return objects should be explicitly tested.* 

- G5.5 Correctness tests should be run with a fixed random seed

Standards on line#129 of file [tests/testthat/test-integration.R](https://github.com/rauschenberger/corila/blob/main/tests/testthat/test-integration.R#L129):

- RE7.2 Demonstrate that output objects retain aspects of input data such as row or case names (see **RE1.3**).

Standards on line#322 of file [tests/testthat/test-integration.R](https://github.com/rauschenberger/corila/blob/main/tests/testthat/test-integration.R#L322):
...
Standards on line#355 of file [tests/testthat/test-integration.R](https://github.com/rauschenberger/corila/blob/main/tests/testthat/test-integration.R#L355):

- RE2.2 Regression Software should provide different options for processing missing values in predictor and response data. For example, it should be possible to fit a model with no missing predictor data in order to generate values for all associated response points, even where submitted response values may be missing.

Standards on line#423 of file [tests/testthat/test-integration.R](https://github.com/rauschenberger/corila/blob/main/tests/testthat/test-integration.R#L423):
...
Standards on line#6 of file [tests/testthat/test-methods.R](https://github.com/rauschenberger/corila/blob/main/tests/testthat/test-methods.R#L6):
...
Standards on line#68 of file [R/srr_stats_standards.R](https://github.com/rauschenberger/corila/blob/main/R/srr_stats_standards.R#L68):
