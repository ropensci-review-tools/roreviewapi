...
Standards in function ' Lowess() 'on line#40 of file [R/Lowess.R](https://github.com/thisisamirv/lowess-project/blob/main/R/Lowess.R#L40):
...
Standards in function ' OnlineLowess() 'on line#33 of file [R/OnlineLowess.R](https://github.com/thisisamirv/lowess-project/blob/main/R/OnlineLowess.R#L33):

- G1.6 Software should include code necessary to compare performance claims with alternative implementations in other R packages.* 

- G2.0 Implement assertions on lengths of inputs, particularly through asserting that inputs expected to be single- or multi-valued are indeed so.

Standards in function ' StreamingLowess() 'on line#33 of file [R/StreamingLowess.R](https://github.com/thisisamirv/lowess-project/blob/main/R/StreamingLowess.R#L33):

- G1.6 Software should include code necessary to compare performance claims with alternative implementations in other R packages.* 

- G2.0 Implement assertions on lengths of inputs, particularly through asserting that inputs expected to be single- or multi-valued are indeed so.

Standards in function ' print.Lowess() 'on line#9 of file [R/methods.R](https://github.com/thisisamirv/lowess-project/blob/main/R/methods.R#L9):

- G1.3 All statistical terminology should be clarified and unambiguously defined.* 

Standards on line#33 of file [R/rfastlowess-package.R](https://github.com/thisisamirv/lowess-project/blob/main/R/rfastlowess-package.R#L33):

- G1.0 Statistical Software should list at least one primary reference from published academic literature.* 

- G1.1 Statistical Software should document whether the algorithm(s) it implements are:* - *The first implementation of a novel algorithm*; or - *The first implementation within **R** of an algorithm which has previously been implemented in other languages or contexts*; or - *An improvement on other implementations of similar algorithms in **R***. 

Standards on line#79 of file [R/srr-stats-standards.R](https://github.com/thisisamirv/lowess-project/blob/main/R/srr-stats-standards.R#L79):
...
Standards in function ' validate_common_args() 'on line#17 of file [R/utils.R](https://github.com/thisisamirv/lowess-project/blob/main/R/utils.R#L17):
...
Standards on line#28 of file [vignettes/rfastlowess-intro.Rmd](https://github.com/thisisamirv/lowess-project/blob/main/vignettes/rfastlowess-intro.Rmd#L28):
...
Standards on line#33 of file [R/srr-stats-standards.R](https://github.com/thisisamirv/lowess-project/blob/main/R/srr-stats-standards.R#L33):
