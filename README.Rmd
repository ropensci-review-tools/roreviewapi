...
[`pkgstats`](https://github.com/ropenscilabs/pkgstats) packages. This suite of
...
`global`](https://www.gnu.org/software/global/). See package
description and those links for how to install those libraries on your system.
This package itself also requires both the [GitHub command-line-interface (cli),
